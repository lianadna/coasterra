										...
										<div class="swiper-wrapper">
												...
												<div class="camping-card-2 widget-style">
													<div class="thumb">
														<a href="{{ route(('campingDetails')) }}">
															<img src="{{ asset('assets/img/thumbs/thumb-4.webp') }}" alt="thumb-2"/>
														</a>
														<div class="date">
													...
													<div class="content">
														<div class="donation-wrap">
															...
															<div class="d-bottom">
																<a href="{{ route('donations') }}" class="e-primary-btn has-small has-icon d-btn">
																	Donate Now
																	<span class="icon-wrap">
																		<span class="icon">
											...
											<div class="swiper-slide">
												<div class="camping-card-2 widget-style">
													<div class="thumb">
														<a href="{{ route(('campingDetails')) }}">
															<img src="{{ asset('assets/img/thumbs/thumb-3.webp') }}" alt="thumb-2"/>
														</a>
														<div class="date">
															<i class="fa-regular fa-clock"></i>
															<span>42 Days Left</span>
											...
											<div class="swiper-slide">
												<div class="camping-card-2 widget-style">
													<div class="thumb">
														<a href="{{ route(('campingDetails')) }}">
															<img src="{{ asset('assets/img/thumbs/thumb-2.webp') }}" alt="thumb-2"/>
														</a>
														<div class="date">
															<i class="fa-regular fa-clock"></i>
															<span>42 Days Left</span>
