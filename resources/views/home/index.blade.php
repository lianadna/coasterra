		...
		<div class="swiper">
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<div class="hero-side" style="background-image: url(assets/img/bg/hero-bg-1.webp)">
						<div class="container">
							<div class="row">
								<div class="col-xl-12">
									<div class="hero-content-1">
										...
										<div class="title" data-animation="animate__fadeInUp" data-delay="0.4s">
											<h1>
												Shape This World to <span>Heart's Concept</span>
											</h1>
										</div>
										<div class="text" data-animation="animate__fadeInUp" data-delay="0.5s">
											<p>
												We plant the seeds of change and nurture nature through community-driven conservation projects and sustainable initiatives.
											</p>
										</div>
				...
				<div class="swiper-slide">
					<div class="hero-side" style="background-image: url(assets/img/bg/hero-bg-6.webp)">
						<div class="container">
							<div class="row">
								<div class="col-xl-12">
									<div class="hero-content-1">
										...
										<div class="title" data-animation="animate__fadeInUp" data-delay="0.4s">
											<h1>
												Build This Earth with
												<span>Heart’s True Vision</span>
											</h1>
										</div>
										<div class="text" data-animation="animate__fadeInUp" data-delay="0.5s">
											<p>
												A seed is planted with care and stewardship; over time it grows into a tree that supports biodiversity and communities.
											</p>
										</div>
										<div class="join-us" data-animation="animate__fadeInUp" data-delay="0.6s">
											<a href="{{ route('donations') }}" class="e-primary-btn has-icon">
									...
									<div class="hero-content-1">
										...
										<div class="text" data-animation="animate__fadeInUp" data-delay="0.5s">
											<p>
												...
												ilikely to then a dental prosthetic is added then
												dental prosthetic.
											</p>
										</div>
										<div class="join-us" data-animation="animate__fadeInUp" data-delay="0.6s">
							...
							<div class="row">
								<div class="col-xl-12">
									<div class="hero-content-1">
										...
										<div class="text" data-animation="animate__fadeInUp" data-delay="0.5s">
											<p>
												A seed is gently first planted, so it slowly starts to grow a tree, then
												blossoms and bears fruit with nature’s help.
											</p>
										</div>
										<div class="join-us" data-animation="animate__fadeInUp" data-delay="0.6s">
											<a href="{{ route('donations') }}" class="e-primary-btn has-icon">
			...
			<div class="row align-items-center">
				<div class="col-xl-6">
					<div class="shape-wrapped-thumb-1" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
						<img src="{{ asset('assets/img/thumbs/thumb-39.webp') }}" alt="thumb"/>
						...
						<div class="positioned-shape">
							<div class="shape-wrapped-thumb-2">
								<div class="video-thumb">
									<img src="{{ asset('assets/img/thumbs/thumb-40.webp') }}" alt="thumb"/>
						...
						<div class="c-tabs-wrapper">
							...
							<div class="tab-content" id="myTabContent">
								<div class="tab-pane fade show active" id="c-tab-1-pane" role="tabpanel" aria-labelledby="c-tab-1" tabindex="0">
									<div class="text">
										<p>
											We collaborate with communities to restore habitats, protect biodiversity, and promote sustainable practices for a healthier planet.
										</p>
									</div>
									<div class="benefits">
										<ul>
											<li>
												Protect ecosystems and support biodiversity
											</li>
											<li>
												Research, education, and community engagement on ecological relationships
											</li>
											<li>Enable community-led conservation initiatives</li>
										</ul>
									</div>
								</div>
								<div class="tab-pane fade" id="c-tab-2-pane" role="tabpanel" aria-labelledby="c-tab-2" tabindex="0">
									<div class="text">
										<p>
											Our programs combine scientific research, hands-on conservation, and long-term stewardship to make a measurable environmental impact.
										</p>
									</div>
									<div class="benefits">
										<ul>
								...
								<div class="tab-pane fade" id="c-tab-3-pane" role="tabpanel" aria-labelledby="c-tab-3" tabindex="0">
									<div class="text">
										<p>
											...
											prosthetic is added then dental prosthetic.
										</p>
									</div>
								</div>
							</div>
		...
		<div class="container">
			<div class="section-top-2">
				...
				<div class="right" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">
					<p>
						Our initiatives are driven by science, community engagement, and sustainable practices.
					</p>
			...
			<div class="row row-gap-md-5 row-gap-4" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="800">
				<div class="col-xl-4 col-md-6 col-sm-12">
					<div class="project-card">
						<div class="thumb">
							<a href="{{ route(('servicesDetails')) }}">
								<img src="{{ asset('assets/img/thumbs/thumb-14.webp') }}" alt="thumb-14"/>
							</a>
							<div class="number">
								<a href="{{ route(('servicesDetails')) }}">No - 01</a>
							</div>
							<div class="content">
								...
								<div class="details-btn">
									<a href="{{ route(('servicesDetails')) }}" class="e-primary-btn has-icon is-hover-white">
										Read More
										<span class="icon-wrap">
											<span class="icon"><i class="fa-regular fa-arrow-right"></i><i class="fa-regular fa-arrow-right"></i></span>
				                        </span>
				...
				<div class="col-xl-4 col-md-6 col-sm-12">
					<div class="project-card">
						<div class="thumb">
							<a href="{{ route(('servicesDetails')) }}">
								<img src="{{ asset('assets/img/thumbs/thumb-15.webp') }}" alt="thumb-15"/>
							</a>
							<div class="number">
								<a href="{{ route(('servicesDetails')) }}">No - 02</a>
							</div>
							<div class="content">
				...
				<div class="col-xl-4 col-md-6 col-sm-12">
					<div class="project-card">
						<div class="thumb">
							<a href="{{ route(('servicesDetails')) }}">
								<img src="{{ asset('assets/img/thumbs/thumb-16.webp') }}" alt="thumb-16"/>
							</a>
							<div class="number">
								<a href="{{ route(('servicesDetails')) }}">No - 03</a>
							</div>
							<div class="content">
			...
			<div class="row row-gap-5 align-items-center">
				<div class="col-xl-6">
					<div class="thumb px-xl-5 left" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
						<div class="thumb-1">
							<img alt="thumb-1" src="{{ asset('assets/img/thumbs/thumb-23.webp') }}">
							<div class="s-shape-1"><img alt="shape-1" src="{{ asset('assets/img/shapes/shape-14.webp') }}"></div>
						</div>
						<div class="thumb-2"><img alt="thumb-2" src="{{ asset('assets/img/thumbs/thumb-22.webp') }}"></div>
						<div class="thumb-3">
							<div class="shape-wrapped-thumb">
								<img alt="thumb-3" src="{{ asset('assets/img/thumbs/thumb-21.webp') }}">
				...
				<div class="col-xl-6">
					<div class="why-us-content" data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000">
						...
						<div class="annual-donation-wrap">
							<a class="e-primary-btn has-icon" href="{{ route('project') }}">Explore All Post
								...
								<div class="swiper-slide">
									<div class="camping-card">
										<div class="thumb">
											...
											<div class="category">
												<a href="{{ route(('campingDonation')) }}">Animal</a>
											</div>
										</div>
										<div class="content">
											<div class="content-top">
												...
												<div class="title">
													<h3><a href="{{ route(('campingDonation')) }}">Sustainable Energy for All: Why
											...
											<div class="donation-wrap">
												...
												<div class="d-bottom">
													<a class="e-primary-btn has-icon d-btn" href="{{ route(('campingDonation')) }}">
														Donate Now
														<span class="icon-wrap"><span class="icon"><i class="fa-regular fa-arrow-right"></i> <i class="fa-regular fa-arrow-right"></i></span></span>
													</a>
								...
								<div class="swiper-slide">
									<div class="camping-card">
										<div class="thumb">
											...
											<div class="category">
												<a href="{{ route(('campingDonation')) }}">Plantation</a>
											</div>
										</div>
										<div class="content">
											<div class="content-top">
												...
												<div class="title">
													<h3>
														<a href="{{ route(('campingDonation')) }}">
															Reforestation and Tree Planting Campaign 2026
														</a>
													</h3>
												</div>
												<div class="text">
											...
											<div class="donation-wrap">
												...
												<div class="d-bottom">
													<a class="e-primary-btn has-icon d-btn" href="{{ route(('campingDonation')) }}">Donate
														Now
														<span class="icon-wrap"><span class="icon"><i class="fa-regular fa-arrow-right"></i> <i class="fa-regular fa-arrow-right"></i></span></span></a>
													<button class="d-wishlist"><i class="fa-regular fa-heart"></i>
									...
									<div class="camping-card">
										...
										<div class="content">
											<div class="content-top">
												...
												<div class="title">
													<h3>
														<a href="{{ route(('campingDonation')) }}">Protecting Endangered Species
					...
					<div class="event-card">
						<div class="card-content">
							...
							<div class="event-card-middle text-start">
								...
								<div class="event-btn">
									<a class="e-primary-btn has-icon" href="{{ route(('campingDetails')) }}">Join Event
										<span class="icon-wrap"><span class="icon"><i class="fa-regular fa-arrow-right"></i><i class="fa-regular fa-arrow-right"></i></span></span></a>
								</div>
							</div>
						</div>
